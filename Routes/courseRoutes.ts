...
import {BookCourse, CancelUserCourseBooking, createCourse,getAllCourses,getTopCourses, getUserBookedCourses} from '../Controllers/coursesController'
...
router.post("/create-course", isApprovedInstructor, createCourse);
 ...
 router.get("/gettopcourses", getTopCourses);
